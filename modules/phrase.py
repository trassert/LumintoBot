...
class server:
    ...
    host = (
        "🌐 : Айпи сервера: `{v4}`\n"
        "\n"
        "Если у вас есть IPv6, попробуйте: `{v6}`\n"
        "Это понизит ваш пинг."
    )
...
class chataction:
    ...
    hello = (
        ...
        "\n"
        "Есть вопросы?\n"
        "1. Можешь задать их в **сообщения канала**:\n"
        "    **lumintoch.t.me**\n"
        "2. Можешь посетить:\n"
        "    **[Информация | Механики](https://t.me/lumintomc/153212)**\n"
        "    **[Канал](https://t.me/lumintoch)**\n"
        "\n"
