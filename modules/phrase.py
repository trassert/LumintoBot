...
class chataction:
    ...
    hello = (
        ...
        "**Пиши сюда свой ник или обратись к trassert_whitelist.t.me**\n"
        "\n"
        "Из важного:\n"
        "    Получить айпи - **/ip**\n"
        "    **[Посмотреть правила](https://t.me/lumintomc/437724)**\n"
        "\n"
        "Остались вопросы?\n"
        "1. Можешь задать их администраторам (мы не кусаемся)\n"
        "    Их список можно получить командой: **/staff**\n"
        "2. Можешь посетить топики:\n"
        "    **[Для новичков](https://t.me/lumintomc/9)**\n"
        "    **[Информация | Механики](https://t.me/lumintomc/153212)**\n"
        "    **[Правила](https://t.me/lumintomc/437724)**\n"
        "\n"
        "И да, если что весь чат с сервера транслируется сюда:\n"
        "    1. Прямо отсюда ты можешь пообщаться с игроками\n"
        "    2. Или посмотреть список игроков (**/list**)\n"
        "\n"
...
game_topic_warning = (
    ...
    f"**[Мини-игры](https://t.me/lumintomc/{chats.topics.games})**"
)
