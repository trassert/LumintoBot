...
class state:
    ...
    require_emerald = "☹️ : Создание государства требует вложений..."
...
class chataction:
    ...
    hello = (
        ...
        "**Пиши в сообщения канала lumintoch.t.me**\n"
        "\n"
    ...
    botscheck = "‼️ : **{}**, для защиты от **«мёртвых душ»** просьба написать хотя-бы одно сообщение."
...
class ai:
    ...
    crocodile_prompt = (
        ...
        "делай подсказки подробными, а не в одно слово. "
        "Если всё понял - пиши OK"
    )
