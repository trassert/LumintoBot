...
class money:
    ...
    change_balance_use = '\nИспользование: `/изменить баланс @durov 10`'
    swap_balance_use = '\nИспользование: `/скинуть @durov 10`'
...
del_admin = '❌ : **Администратор удалён!**'
...
no_server = '❌ : Нет такого сервера!'
no_days = '❌ : Неверно введено количество дней!'

active = '📊 : Топ **активных людей** за {} дней: \n'
unactive = '📊 : Созыв всех неактивных!\n'
no_response = '❌ : Введите свой запрос!'
